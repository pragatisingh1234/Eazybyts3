            ...
            <div className='flex flex-col items-center'>
              {user ?
                <button
                  ...
                  className='bg-teal-600 w-full rounded-md py-2 mt-2 text-white font-medium lg:text-xl text-xl md:text-sm'
                >
                  Continue to secure payment
                </button>
                :
                <Link className='w-full' to='/login'><button
                  className='bg-teal-600 w-full rounded-md py-2 px-4  mt-2 text-white font-medium lg:text-xl text-xl md:text-sm'
                >
                  Login to Purchase
                </button></Link>}
