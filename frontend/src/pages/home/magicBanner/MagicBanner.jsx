...
import marriagepik from "./image/marriagepik.jpeg";
import party from "./image/party.jpeg";
import party2 from "./image/party2.jpeg";
  ...
  return (
    <div className="mt-12 lg:mt-10">
      <div className={`carousel ${isNext ? "next" : ""} ${isPrev ? "prev" : ""}`}>
        <div className="list">
          {[Birthday, marriagepik, party, party2].map((img, index) => (
            <div
              className="item"
              key={index}
            ...
            >
              ...
              <div className="content">
                ...
                */}
                ...
                <div>
                  <div>
                    <p className="text-xl ml-1 font-semibold tracking-wider text-slate-300">Eventoman</p>
                  </div>
                  ...
                  <div className="w-2/3 hidden lg:flex ">
                    <p className="text-slate-200">
                      From elegant ambience to lively gatherings, we curate diverse events for every occasion, guaranteeing a memorable experience for all guests.
                    </p>
                  </div>
                </div>
                {/* using tailwind  */}
                ...
                <Link to="/events">
                  <button
                    type="button"
                    className="mt-14 text-white bg-gradient-to-r from-teal-500 to-teal-300 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-pink-300 dark:focus:ring-pink-800 font-medium rounded-lg text-lg px-7 py-2 text-center  mb-2"
                  >
                    See More
                  </button>
                </Link>
