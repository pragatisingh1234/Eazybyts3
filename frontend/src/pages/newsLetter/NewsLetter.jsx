            ...
            <div className="mt-5 md:mt-20 lg:mt-10">
              <form onSubmit={handleSubmit} className="flex justify-center pb-5">
                ...
                <input
                  type="submit"
                  value="Subscribe"
                  className="bg-teal-500 text-white p-3 rounded-r-lg cursor-pointer"
                />
              </form>
              <p className="text-white text-center px-10 hidden lg:flex">
                {" "}
               
                Eventoman strives to deliver the best User Experience, based on what user 
                has requested, we work on user's deatils in order to provide offers tailored 
                to user's interests.
