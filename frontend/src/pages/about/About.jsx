...
import crackers from "../../assets/about/crackers.jpeg";
import birthday from "../../assets/about/birthday.jpeg";
import dance from "../../assets/about/dance.jpeg";
import mocktails from "../../assets/about/mocktails.jpeg";
import Add from "./Add";
    ...
    <div className=" ">
      <div className="">
        ...
        <div className="-mt-[75px] md:-mt-40">
          ...
          <h3 className="text-xl md:text-3xl font-semibold text-center text-teal-500 font-serif">
            Eventoman
          </h3>
          <p className="uppercase text-center md:text-2xl">
            Turn your desires to reality
          </p>
        </div>
      ...
      <div className=" p-3 space-y-7 mt-5 md:mt-20  md:max-w-6xl mx-auto">
        ...
        <div className="md:flex gap-5 ">
          <div className="h-full w-full ">
            <img className="h-[250px] w-[350px]" src={crackers} alt="" />
          </div>

          <div className="">
            <h4 className="text-2xl mb-2 mt-2 ">Original</h4>
            <p className="text-sm">
              We work upon customisation, turn people dreams and desires to reality
              with the vision to make events memorable. And We
              are “Eventoman” With our young and creative minds, we
        ...
        <div className="md:flex flex-row-reverse gap-5 ">
          <div className="h-full w-full">
            <img className="h-[250px] w-[350px]" src={birthday} alt="" />
          </div>
          <div>
        ...
        <div className="md:flex gap-5 ">
          <div className="h-full w-full">
            <img className="h-[250px] w-[350px]" src={mocktails} alt="" />
          </div>
          <div className="lg:-ml-32">
            <h4 className="text-2xl mb-2 mt-2">Meticulous</h4>
            <p>
