  ...
  return (
    <div className="rounded-md shadow-lg transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105 hover:shadow-lg bg-white hover:bg-gray-100">
      <div className="rounded-t-md shadow-lg h-60 relative overflow-hidden ">
        ...
        />
        <div className="absolute bg-gradient-to-r from-teal-600 to-teal-200   hover:bg-gradient-to-br bottom-0 left-0 px-6 py-3 text-white font-semibold rounded-tr-md flex items-center gap-3">
          {" "}
        ...
        <div className="flex justify-between items-center mt-4">
          <div className="flex gap-2 items-center">
            <p className="text-sm text-secondary font-medium flex gap-2">
              <TbListDetails className="text-teal-500 text-base" />
              {product_description}
            </p>
          </div>
        </div>
      ...
      <div className="flex justify-center mb-2">
        <button
          type="button"
          className=" text-white bg-gradient-to-r from-teal-700 to-teal-200 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-pink-300 dark:focus:ring-pink-800 shadow-lg shadow-pink-500/50 dark:shadow-lg dark:shadow-pink-800/80 font-medium rounded-lg lg:text-lg px-5 py-2.5 text-center me-2 mb-2 mt-2"
          onClick={addToCart}
        >
