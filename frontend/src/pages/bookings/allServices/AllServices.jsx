      ...
      <div className="md:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-8 lg:gap-24 m-3 lg:m-12">
        ...
        <div className="rounded-md shadow-lg transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105 hover:shadow-lg bg-white hover:bg-gray-100">
          <div className="rounded-t-md shadow-lg h-60 relative overflow-hidden ">
            ...
            />
            <div className="absolute bg-gradient-to-r from-teal-500 via-teal-600 to-teal-700   hover:bg-gradient-to-br bottom-0 left-0 px-6 py-3 text-white font-semibold rounded-tr-md flex items-center gap-3">
              {" "}
          ...
          <div className="px-4 py-6">
            <div className="flex justify-between">
              <p className="text-sm text-secondary font-medium flex gap-2">
                <FaCalendarAlt className="text-teal-600 text-base" />
                Book Your Date
              </p>
              <p className="text-sm text-secondary font-medium flex gap-1">
                <CiLocationOn className="text-teal-600 text-lg font-bold" />
                In Your Location
              </p>
            </div>
            ...
            <div className="flex justify-center">
              <Link to="/create-your-event">
                <button
                  type="button"
                  className=" text-white bg-gradient-to-r from-teal-400 via-teal-500 to-teal-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-teal-300 dark:focus:ring-teal-800 shadow-lg shadow-teal-500/50 dark:shadow-lg dark:shadow-teal-800/80 font-medium rounded-lg lg:text-lg px-5 py-2.5 text-center me-2 mb-2"
                >
        ...
        <div className="rounded-md shadow-lg transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105 hover:shadow-lg bg-white hover:bg-gray-100">
          <div className="rounded-t-md shadow-lg h-60 relative overflow-hidden ">
            <img
              ...
              className="rounded-t-md h-full w-full object-cover transform transition-transform duration-500 hover:scale-110"
            />
            <div className="absolute bg-gradient-to-br from-teal-500 to-blue-400 hover:bg-gradient-to-bl bottom-0 left-0 px-6 py-3 text-white font-semibold rounded-tr-md flex items-center gap-3">
              {" "}
              <FaPeopleGroup />
              Organize
            </div>
          ...
          <div className="px-4 py-6">
            <div className="flex justify-between">
              <p className="text-sm text-secondary font-medium flex gap-2">
                <FaPeopleLine className="text-teal-600 text-base" />
                Become an Organizer
              </p>
              <p className="text-sm text-secondary font-medium flex gap-1">
                <CiLocationOn className="text-teal-600 text-lg font-bold" />
            ...
            <div className="flex justify-center">
              <Link to="/request-organizer">
                <button
                  type="button"
                  className=" text-white bg-gradient-to-br from-teal-500 to-blue-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-teal-200 dark:focus:ring-teal-800 font-medium rounded-lg lg:text-lg px-5 py-2.5 text-center me-2 mb-2"
                >
        ...
        <div className="rounded-md shadow-lg transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105 hover:shadow-lg bg-white hover:bg-gray-100">
          <div className="rounded-t-md shadow-lg h-60 relative overflow-hidden ">
            <img
              ...
              className="rounded-t-md h-full w-full object-cover transform transition-transform duration-500 hover:scale-110"
            />
            <div className="absolute bg-gradient-to-r from-purple-500 to-teal-500 hover:bg-gradient-to-l bottom-0 left-0 px-6 py-3 text-white font-semibold rounded-tr-md flex items-center gap-3">
              {" "}
              <FaShoppingBag />
              Shop
            </div>
          ...
          <div className="px-4 py-6">
            <div className="flex justify-between">
              <p className="text-sm text-secondary font-medium flex gap-2">
                <FaCartShopping className="text-teal text-base" />
                Buy now
              </p>
              <p className="text-sm text-secondary font-medium flex gap-1">
                <BsShop className="text-teal-400 text-lg font-bold" />
                Explore our Shop
              </p>
            </div>
            <h2 className="p-1 text-center text-2xl mt-2 font-semibold text-secondary capitalize">
            ...
            <div className="flex justify-center">
              <Link to="/shop">
                <button
                  type="button"
                  className=" text-white bg-gradient-to-r from-purple-500 to-teal-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-teal-800 font-medium rounded-lg lg:text-lg px-5 py-2.5 text-center me-2 mb-2"
                >
