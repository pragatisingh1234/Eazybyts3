        ...
        <div className="flex w-full items-center justify-between md:max-w-7xl md:px-12 mx-auto">
          ...
          <div className="flex justify-center items-center">
            <Link
              ...
              to="/"
            >
              <img src={logo} className="w-24 md:w-36" alt="Eventoman Logo" />
            </Link>
          </div>
          <div
          ...
          >
            <ul className="flex mx-auto flex-col md:flex-row justify-center gap-5 py-3">
              <li>
                <NavLink to="/" className="border hover:text-teal-400 border-white p-1">
                  Home
                </NavLink>
              </li>
              <li>
                <NavLink to="/events" className="border hover:text-teal-400 border-white p-1">
                  Events
                </NavLink>
              </li>
              <li>
                <NavLink to="/booking" className="border hover:text-teal-400 border-white p-1">
                  Booking
                </NavLink>
              </li>
              {/* <li>
              ...
              <li>
                <NavLink to="/shop" className="border hover:text-teal-400 border-white p-1">
                  Shop
                </NavLink>
              </li>
              <li>
                <NavLink to="/about" className="border hover:text-teal-400 border-white p-1">
                  About
                </NavLink>
              </li>
              <li>
                <NavLink to="/portfolio" className="border hover:text-teal-400 border-white p-1">
                  Portfolio
                </NavLink>
              </li>
              <li>
                <NavLink to="/contact" className="border hover:text-teal-400 border-white p-1">
                  Contact
                </NavLink>
              </li>
          ...
          {user ? (
            ...
            <div className="flex items-center gap-2">
              <Link
                to="/login"
                type="button"
                className="inline-block rounded bg-green-100 px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-teal-900 transition duration-150 ease-in-out hover:bg-primary/20 focus:bg-primary/30 focus:outline-none focus:ring-0 active:bg-primary/20"
              >
                Login
              </Link>
              <Link
                to="/register"
                type="button"
                className="mr-3 inline-block rounded bg-green-500 px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-teal-900 shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-teal-100 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-teal-100 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-teal-300"
              >
                Sign Up
              </Link>
            </div>
