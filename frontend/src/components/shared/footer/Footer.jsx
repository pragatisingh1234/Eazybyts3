        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 py-5">
          <div>
            ...
            <p className="mt-6 max-w-md text-center leading-relaxed text-gray-500 sm:max-w-xs sm:text-left">
              Eventoman, is where we craft dreams into reality, we specialize in turning your events into
              extraordinary experiences. Our Event Management System is designed
            ...
            <ul className="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
              <li>
                <a
                  ...
                  rel="noreferrer"
                  target="_blank"
                  className="text-teal-500 hover:text-teal-100"
                >
            ...
            <div className="text-center sm:text-left">
              ...
              <ul className="mt-8 space-y-4 text-sm">
                ...
                <li className="flex items-center justify-center gap-1.5 ">
                  ...
                  <a href="mailto:info@dreamcraft.com">eventoman123.com</a>                  </span>
                </li>
        ...
        <div className="mt-12 border-t border-gray-100 py-6">
          <div className="text-center sm:flex sm:justify-between sm:text-left">
            ...
            <p className="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0">
              © {new Date().getFullYear()} Eventoman
            </p>
          </div>
        </div>
      </Container>
