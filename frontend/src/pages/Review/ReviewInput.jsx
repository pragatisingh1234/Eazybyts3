        ...
        <div className="bg-slate-100 rounded-lg pt-7 py-2 w-full md:w-2/3 md:px-6">
          <form onSubmit={handleSubmitReview} className="grid justify-center">
            ...
            <div className="font-bold w-full md:w-4/5 mx-auto mt-3 border-red-600 text-center">
              ...
              <textarea className="w-full p-2 rounded-lg border border-teal-600 mx-auto" maxLength="30" name="name" rows="1" placeholder="Your Name" required></textarea>
            </div>
            <div className="md:w-4/5 mx-auto mt-3">
              <label className="label-text font-serif">Write review</label>
              <textarea className="w-full p-2 rounded-lg border border-teal-600 mx-auto" maxLength="200" name="text" rows="4" placeholder="Write a review..." required></textarea>
            </div>



            <input type="submit" value="Add Review" className="text-white w-full md:w-auto mx-auto mt-4 p-2 bg-gradient-to-r from-teal-600 to-teal-300 hover:bg-gradient-to-br focus:outline-none focus:ring-teal-100 dark:focus:ring-teal-800 shadow-lg shadow-pink-500/50 dark:shadow-lg dark:shadow-teal-300 lg:w-auto hover:bg-teal-600 focus:ring-4 focus:ring-opacity-50 rounded-lg px-5 mb-5" />
          </form>
        </div>
      </div>
    </>
